            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">Kristen 2 YSKI</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Silahkan Masuk Menggunakan Akun Yang Sudah Disediakan</h5>
                  </div>

                  <form class="row g-3 needs-validation" novalidate action="{{route('loginPros')}}" method="POST">
                    @csrf
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" name="password" class="form-control" id="yourPassword" placeholder="Masukan password anda...">
                    </div>
                    <div class="col-12">
              ...
              <div class="credits">
                ...
                Designed by <a href="#">Andreas Pratama</a>
              </div>
