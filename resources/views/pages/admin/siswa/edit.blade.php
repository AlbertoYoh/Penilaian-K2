    ...
    <section class="section">
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Edit Karya</h5>
              ...
              <form action="{{route('siswa.update', $item->id)}}" method="POST">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" placeholder="Nama Siswa..." value="{{$item->nama}}">
                    @error('nama')
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control @error('nisn') is-invalid @enderror" name="nisn" placeholder="NISN..." value="{{$item->nisn}}">
                    @error('nisn')
                        <div class="invalid-feedback">
                            {{$message}}
                        </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control @error('kelas') is-invalid @enderror" name="kelas" placeholder="Kelas..." value="{{$item->kelas}}">
                    @error('kelas')
                        <div class="invalid-feedback">
                            {{$message}}
                        </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <select class="form-select" aria-label="Default select example" name="mapel_id">
                      <option value="{{$item->mapel_id}}">-- Ubah Bila Diperlukan --</option>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <a href="{{route('siswa.index')}}" class="btn btn-secondary">Kembali <i class="fa-solid fa-backward ms-2"></i></a>
                    </div>
                </div>
              </form>
